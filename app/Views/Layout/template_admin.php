...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">ESJA Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseData" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/datapaket">Paket</a>
                        <a class="collapse-item" href="/dataproyek">Proyek</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEsja"
                    aria-expanded="true" aria-controls="collapseEsja">
                    <i class="fas fa-fw fa-atlas"></i>
                    <span>ESJA</span>
                </a>
                <div id="collapseEsja" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom ESJA:</h6>
                        <a class="collapse-item" href="/tentangkami">Tentang Kami</a>
                        <a class="collapse-item" href="/datakontak">Kontak Perusahaan</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b>ESJA Admin</b></span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>
                            Copyright &copy; 2020 ESJA, All rights reserved by 
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mzaasya@gmail.com&su=Website_Request&body=Type_Your_Request" class="text-dark">mzaasya</a>
                        </span>
                    </div>
                </div>
            </footer>
    ...
    <script src="<?= base_url('brain.js') ?>"></script>
